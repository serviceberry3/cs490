"""
This file is taken from starter code provided in the Yale course CPSC 419 (Full-Stack Web Programming).
Modified by Noah S. Weiner to fit my needs for this CPSC 490 project.
        ...
        if recompute or not self._column_widths:
            ...
            for fmt, column in zip(self._format_spec, columns):
                ...
                if fmt == FormatSpec.PREFORMATTED:
                    col_lines = []
                    for row in column:
                        #it's possible that data could be None (ie some prods don't have an aisle)
                        if row != None:
